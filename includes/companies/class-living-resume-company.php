 ...
 * @subpackage Living_Resume/includes/company
 * @author     Cristina D'Anni <cristina.danni@gmail.com>
 *
 * This class defines all code necessary to create the Company CPT during plugin's activation.
 */
class Living_Resume_Company {
	...
	public function load() {
		...
		$lr_company->new_cpt_lr_company();

		/**
		 * Let's pull in some custom fields, shall we?
		 * Custom fields are via CMB2, because who wants to reinvent the wheel?
		 */
		require_once LIVING_RESUME_PATH . 'includes/companies/living-resume-company-fields.php';
	}

	/**
	 * Creates the new custom post type Company
	 *
	 * @since 	1.0.0
	 * @access 	public
	 * @uses 	register_post_type()
	 */
	public static function new_cpt_lr_company() {
		...
		$opts = apply_filters( 'living-resume-cpt-company-options', $opts );
